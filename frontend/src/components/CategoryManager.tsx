    ...
    <div className="category-manager-section" id="category-manager">
      ...
      <div className="cat-add-row">
        <input
          ...
          placeholder={t.categoriesPage.newCategory(activeTab === "INCOME" ? t.common.income : t.common.expense)}
          value={newName}
      ...
      <div className="cat-list">
        {categories.length === 0 ? (
          <div className="cat-empty">
            <p>{t.categoriesPage.empty(activeTab === "INCOME" ? t.common.income : t.common.expense)}</p>
          </div>
        ) : (
          categories.map((cat) => (
              ...
              {editingId === cat.id ? (
                ...
                <div className="cat-edit-row">
                  ...
                  <div className="cat-edit-actions">
                    <button className="action-btn save" onClick={handleSaveEdit} title={t.common.save}>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                        <polyline points="20 6 9 17 4 12" />
                      </svg>
                    </button>
                    <button className="action-btn cancel" onClick={cancelEdit} title={t.common.cancel}>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                ...
                <div className="cat-confirm-row">
                  <span className="cat-confirm-text">{t.categoriesPage.deleteConfirm(cat.name)}</span>
                  <div className="cat-edit-actions">
                    <button
                      className="action-btn delete"
                      onClick={() => handleDelete(cat.id)}
                      disabled={deletingId === cat.id}
                      title={t.categoriesPage.confirmDelete}
                    >
                      {deletingId === cat.id ? (
                ...
                <>
                  ...
                  <div className="cat-actions">
                    <button className="action-btn edit" onClick={() => startEdit(cat)} title={t.common.edit}>
                      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7" />
                        <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z" />
                      </svg>
                    </button>
                    <button className="action-btn delete" onClick={() => setConfirmDeleteId(cat.id)} title={t.common.delete}>
                      <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
